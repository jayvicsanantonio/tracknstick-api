...
describe('Security Configuration', () => {
  ...
  describe('getSecurityConfig', () => {
    ...
    it('should have different rate limits per environment', () => {
      ...
      expect(prodConfig.rateLimit.globalLimit).toBeLessThan(
  ...
  describe('validateSecurityConfig', () => {
    ...
    it('should reject config with negative endpoint rate limit', () => {
      ...
      expect(result.errors).toContain(
        'Rate limit for /api/test must be positive'
      );
    });
    ...
    it('should reject config with zero endpoint window', () => {
      ...
      expect(result.valid).toBe(false);
      expect(result.errors).toContain(
        'Rate limit window for /api/test must be positive'
      );
    });
  ...
  describe('environment-specific configurations', () => {
    it('should have stricter production CORS settings', () => {
      ...
      expect(
        devConfig.cors.origins.some((origin) => origin.includes('localhost'))
      ).toBe(true);
    });
